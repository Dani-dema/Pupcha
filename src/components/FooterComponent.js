            ...
            <div className="row justify-content-center">
                ...
                <div className="col-12 col-sm-4 align-self-center">
                    <div className="text-center">
                        <h6>Follow us: </h6>
                        <p> 
                        <a className="btn btn-social-icon " href="https://www.facebook.com/ramadan.dema.7"><i className="fa fa-facebook"></i></a>
                        <a className="btn btn-social-icon" href="https://www.linkedin.com/in/%F0%9F%91%A8%E2%80%8D%F0%9F%92%BBramadan-dema-128b49193/"><i className="fa fa-linkedin"></i></a>
                        <a className="btn btn-social-icon " href="https://www.instagram.com/dani__dema/"><i className="fa fa-instagram"></i></a>
                        ...
                        <a className="btn btn-social-icon " href="http://twitter.com/"><i className="fa fa-instagram"></i></a>
                        </p>
                    </div>
                </div>
            </div>
