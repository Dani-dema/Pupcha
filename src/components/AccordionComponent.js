        ...
        return (
           <div>
                    ...
                    <TabContent activeTab={activeTab} className="tabcontent">
                        <TabPane tabId="2">
                        <Row >
                        <Col sm="5">  <img  style={{marginLeft:"30px"}} src="assets/images/image-captcha.png" height="400" width="320" alt="Captcha" /> </Col> 
                            <Col sm="6">
                            <h4>Captcha bazuar ne imazhe</h4>
                            <p>CAPTCHA të bazuara në imazhe u zhvilluan për të zëvendësuar ato të bazuara në tekst. Këto CAPTCHA përdorin elemente grafikë të njohur, të tilla si foto të kafshëve, forma ose skena. Në mënyrë tipike, CAPTCHA e bazuara në imazhe u kërkojnë përdoruesve të zgjedhin imazhe që përputhen me një temë.</p>
                            <p>CAPTCHA e bazuara në imazhe janë zakonisht më të lehta për t'u interpretuar nga njerëzit sesa ato bazuar në tekst. Sidoqoftë, këto mjete paraqesin çështje të dallueshme të hyrjes për përdoruesit e dëmtuar nga shikimi. Përsa i perket "bots", CAPTCHA e bazuara në imazhe janë më të vështira sesa teksti për t'u interpretuar sepse këto mjete kërkojnë njohjen e imazhit dhe klasifikimin semantik.</p>
                            </Col>
                    ...
                    <TabPane tabId="3">
                        <Row>
                          <Col sm="7">
                            ...
                            <p>Audio CAPTCHA u zhvilluan si një alternativë që u jep mundësi përdoruesve të dëmtuar nga shikimi. Këto CAPTCHA përdoren shpesh në kombinim me tekst ose CAPTCHA të bazuara në imazh. CAPTCHA-të audio paraqesin një regjistrim audio të një serie shkronjash ose numrash që fut një përdorues.
                                    <br />
                                  Këto CAPTCHA mbështeten në bot që nuk janë në gjendje të dallojnë karakteret përkatëse nga zhurma e sfondit. Ashtu si CAPTCHA e bazuara në tekst, këto mjete mund të jenë të vështira për t’u interpretuar nga njerëzit, si dhe për botët.</p>
                          </Col>
                          <Col sm="3">
                        ...
                        <Row >
                            ...
                            <p>CAPTCHA e bazuara në tekst janë mënyra origjinale në të cilën njerëzit janë verifikuar. Këto CAPTCHA mund të përdorin fjalë ose fraza të njohura, ose kombinime të rastësishme të shifrave dhe shkronjave. Disa CAPTCHA të bazuara në tekst gjithashtu përfshijnë ndryshime në shkronjat e mëdha.
                        ...
                        <TabPane tabId="5">
                          <Row>
                          <Col sm="6">  <img  style={{borderRadius:"10px", marginTop:"10px"}} src="assets/images/recaptcha.png" height="180" width="400" alt="Ristorante Con Fusion" /> </Col> 
                            <Col sm="6" >
                            <h4>Recaptcha</h4>
